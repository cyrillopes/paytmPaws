...
app.post("/paynow", [parseUrl, parseJson], (req, res) => {
  ...
  if (
    ...
    params["CALLBACK_URL"] = "https://pawpaytm.herokuapp.com/callback";
      ...
      function (err, checksum) {
        ...
        var post_req = https.request(options, function (post_res) {
          ...
          post_res.on("end", function () {
            ...
            res.redirect(
              `https://9bcf0e50669d-shared.lowcodeunit.com/viewOrders?status=${_results.STATUS}&ORDERID=${_results.ORDERID}&date=${_results.TXNDATE}&bank=${_results.BANKNAME}`
            );
          });
        });
